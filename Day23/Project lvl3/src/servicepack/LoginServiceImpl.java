...
public class LoginServiceImpl implements LoginService,Cloneable{
	...
	public boolean checkUser(String uname, String upass) {
		...
		UserDTO userDTO=UserDAOImpl.getUserDaoImpl().findByName(uname);
		if(userDTO!=null) {
	...
	public int updateFlag(String uname, int flag) {
		...
		if(userDTO!=null) {
			...
			n=UserDAOImpl.getUserDaoImpl().updateUser(userDTO);
		}
	...
	public int registerUser(int uid, String uname, String upass, int flag) {
		...
		int n=UserDAOImpl.getUserDaoImpl().insertUser(userDTO);
		return n;
	}
